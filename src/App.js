...
const EXERCISE_MUSCLES = {
  // ГРУДЬ
  'Жим лёжа':               { primary: ['chest'],           secondary: ['triceps','shoulders'] },
  'Жим гантелей лёжа':      { primary: ['chest'],           secondary: ['triceps','shoulders'] },
  'Жим гантелей наклон':    { primary: ['chest'],           secondary: ['shoulders','triceps'] },
  'Жим штанги в наклоне':   { primary: ['chest'],           secondary: ['shoulders','triceps'] },
  'Разводка гантелей':      { primary: ['chest'],           secondary: ['shoulders'] },
  'Кроссовер':              { primary: ['chest'],           secondary: ['shoulders'] },
  'Отжимания':              { primary: ['chest'],           secondary: ['triceps','shoulders'] },
  'Пуловер':                { primary: ['chest','lats'],    secondary: [] },
  'Жим в тренажёре на грудь': { primary: ['chest'],         secondary: ['triceps','shoulders'] },
  // ПЛЕЧИ
  'Жим над головой':         { primary: ['shoulders'],      secondary: ['triceps','traps'] },
  'Жим Арнольда':            { primary: ['shoulders'],      secondary: ['triceps'] },
  'Вертикальный жим':        { primary: ['shoulders'],      secondary: ['triceps','traps'] },
  'Разводка гантелей стоя':  { primary: ['shoulders'],      secondary: [] },
  'Разведение гантелей стоя':{ primary: ['shoulders'],      secondary: [] },
  'Тяга к лицу':             { primary: ['shoulders'],      secondary: ['upper_back','traps'] },
  'Разводка в наклоне':      { primary: ['shoulders'],      secondary: ['upper_back'] },
  'Тяга к подбородку':       { primary: ['shoulders','traps'], secondary: ['biceps'] },
  'Обратная разводка':       { primary: ['shoulders'],      secondary: ['upper_back'] },
  'Жим Соца':                { primary: ['shoulders'],      secondary: ['triceps','quads'] },
  // ТРАПЕЦИИ
  'Шраги':                   { primary: ['traps'],          secondary: [] },
  // СПИНА
  'Тяга штанги в наклоне':   { primary: ['lats','upper_back'], secondary: ['biceps','traps'] },
  'Тяга гантели в наклоне':  { primary: ['lats','upper_back'], secondary: ['biceps'] },
  'Тяга горизонтального блока': { primary: ['lats','upper_back'], secondary: ['biceps'] },
  'Тяга вертикального блока': { primary: ['lats'],          secondary: ['biceps','upper_back'] },
  'Тяга Т-штанги':           { primary: ['lats','upper_back'], secondary: ['biceps','traps'] },
  'Подтягивания':            { primary: ['lats'],           secondary: ['biceps','upper_back'] },
  'Гиперэкстензия':          { primary: ['lower_back'],     secondary: ['glutes','hamstrings'] },
  // БИЦЕПС
  'Подъём штанги на бицепс':         { primary: ['biceps'], secondary: ['forearms'] },
  'Подъём гантелей на бицепс':       { primary: ['biceps'], secondary: ['forearms'] },
  'Молотки':                         { primary: ['biceps'], secondary: ['forearms'] },
  'Молотки лёжа':                    { primary: ['biceps'], secondary: ['forearms'] },
  'Изолированные сгибания на бицепс':{ primary: ['biceps'], secondary: [] },
  'Сгибания на скамье Скотта':       { primary: ['biceps'], secondary: [] },
  'Сгибания на блоке':               { primary: ['biceps'], secondary: ['forearms'] },
  // ТРИЦЕПС
  'Французский жим':                    { primary: ['triceps'], secondary: [] },
  'Разгибания на блоке':                { primary: ['triceps'], secondary: [] },
  'Разгибание из-за головы на трицепс': { primary: ['triceps'], secondary: [] },
  'Отжимания на брусьях':               { primary: ['triceps'], secondary: ['chest','shoulders'] },
  // НОГИ — КВАДРИЦЕПС
  'Приседания':                    { primary: ['quads','glutes'],    secondary: ['hamstrings','lower_back'] },
  'Фронтальный присед':            { primary: ['quads','glutes'],    secondary: ['core','shoulders'] },
  'Жим ногами':                    { primary: ['quads','glutes'],    secondary: ['hamstrings'] },
  'Разгибание ног':                { primary: ['quads'],             secondary: [] },
  'Болгарские выпады':             { primary: ['quads','glutes'],    secondary: ['hamstrings'] },
  'Выпады':                        { primary: ['quads','glutes'],    secondary: ['hamstrings'] },
  'Приседания с гантелью (гоблет)':{ primary: ['quads','glutes'],    secondary: ['core'] },
  'Гакк-приседания':               { primary: ['quads','glutes'],    secondary: [] },
  // НОГИ — БИЦЕПС БЕДРА
  'Становая тяга':   { primary: ['hamstrings','glutes','lower_back'], secondary: ['traps','lats'] },
  'Румынская тяга':  { primary: ['hamstrings','glutes'],              secondary: ['lower_back'] },
  'Сгибание ног':    { primary: ['hamstrings'],                       secondary: ['glutes'] },
  // ЯГОДИЦЫ
  'Ягодичный мост':         { primary: ['glutes'],  secondary: ['hamstrings'] },
  'Отведение ноги в блоке': { primary: ['glutes'],  secondary: [] },
  'Махи гирей':             { primary: ['glutes','hamstrings'], secondary: ['lower_back','shoulders'] },
  // ПРЕСС
  'Скручивания':              { primary: ['abs'], secondary: [] },
  ...
  // ИКРЫ
  'Подъём на икры сидя': { primary: ['calves'], secondary: [] },
}
...
const GRIP_MUSCLES = {
  'Тяга вертикального блока': {
    'Стандартный': { primary: ['lats'],        secondary: ['biceps','upper_back'] },
    'Широкий':     { primary: ['lats'],        secondary: ['upper_back'] },
    'Узкий':       { primary: ['lats'],        secondary: ['biceps','upper_back'] },
    'Обратный':    { primary: ['lats','biceps'],secondary: [] },
  },
  'Тяга горизонтального блока': {
    'Стандартный': { primary: ['lats','upper_back'], secondary: ['biceps'] },
    'Широкий':     { primary: ['upper_back'],        secondary: ['lats'] },
    'Узкий':       { primary: ['lats','upper_back'], secondary: ['biceps'] },
    'Обратный':    { primary: ['biceps','lats'],      secondary: [] },
  },
  'Подтягивания': {
    'Стандартный': { primary: ['lats'],        secondary: ['biceps','upper_back'] },
    'Широкий':     { primary: ['lats'],        secondary: ['upper_back'] },
    'Узкий':       { primary: ['lats'],        secondary: ['biceps'] },
    'Обратный':    { primary: ['biceps','lats'],secondary: [] },
  },
  'Тяга штанги в наклоне': {
    'Стандартный': { primary: ['lats','upper_back'], secondary: ['biceps','traps'] },
    'Широкий':     { primary: ['upper_back'],        secondary: ['lats','traps'] },
    'Узкий':       { primary: ['lats'],              secondary: ['biceps','upper_back'] },
    'Обратный':    { primary: ['biceps','lats'],      secondary: ['upper_back'] },
  },
  'Жим лёжа': {
    'Стандартный': { primary: ['chest'],    secondary: ['triceps','shoulders'] },
...
function MuscleMap({ muscleScores, period = 7 }) {
  ...
  const getColor = (muscle) => {
    const level = muscleScores[muscle]?.color || 'none'
  ...
  const hoveredScore = muscleScores[hovered] || { load: 0, label: 'Нет', color: 'none', percent: 0 }
  ...
  return (
    <div className="app" data-theme={settings.theme}>
      ...
      {tab === 'progress' && (() => {
        ...
        const muscleScores = calcMuscleLoad(recentHistory, musclePeriod)
        return (
        <div className="section">
          {stats && (
